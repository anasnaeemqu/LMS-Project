    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeptCourses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeptCourses_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudCourses", x => x.Id);
                    table.ForeignKey(
                        ...
                        principalColumn: "Num");
                    table.ForeignKey(
                        name: "FK_StudCourses_Students_StudId",
                        column: x => x.StudId,
